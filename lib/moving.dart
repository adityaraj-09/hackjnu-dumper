...
import 'package:hackjnu_dumper/dumper.dart';
import 'package:hackjnu_dumper/loading.dart';
import 'package:hackjnu_dumper/map.dart';
...
class MovingPage extends StatefulWidget {
  var dumping;
  MovingPage({super.key, required this.dumping});
...
class _MovingPageState extends State<MovingPage> {
  ...
  bool loading = false;
  void resetDumper(String id, List loc) {
    apiService.resetDumper(context, id, loc).then((value) => {
          nextScreenReplace(
              context,
              StartPage(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        nextScreen(context, const StartPage());
                      },
